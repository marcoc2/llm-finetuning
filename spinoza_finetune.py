...
dataset = load_dataset("json", data_files="dataset_spinoza.jsonl", split="train")
...
model.save_pretrained("spinoza_llama_lora")
tokenizer.save_pretrained("spinoza_llama_lora")
